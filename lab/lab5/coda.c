...
/* Scrivere i sottoprogrammi in, out, print, reset per gestire una struttura dati di tipo coda (statica, a dimensione fissa).
Una coda è una sequenza di N elementi la cui posizione, che varia nell'intervallo [0,N-1], rappresenta l'ordine di arrivo di ciascun elemento.
L'elemento di posizione 0 è l'elemento più vecchio inserito ed il primo ad essere rimosso mentre l'elemento N-1 è l'ultimo inserito. */
